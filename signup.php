...
if(isset($_POST["reg_submit"])) {
        ...
        if($flag == 0)
        {
            ...
            $sql = "INSERT INTO user (`name`,`email`,`phone`,`pass`,`address`)
                    VALUES('$name','$email','$contactNo','$hash_pass','$address')";
                    // echo $sql;
...
<?php
     if(isset($flag)) {
         if($flag === 0 && isset($_POST['reg_submit'])) {
            echo "<div class='alert bg-danger' role='alert'>
                                <span class='text-green text-center'>Account Created Successfully</span>
            ...
            echo "<div class='alert bg-danger' role='alert'>
                                <span class='text-red text-center'>Fill The Form Correctly</span>
                                  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                                    <span aria-hidden='true'>&times;</span>
                                  </button>
                              </div>";
